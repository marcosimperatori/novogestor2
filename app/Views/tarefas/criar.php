...
<div class="my-2">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?php echo site_url("tarefas"); ?>">Tarefas</a></li>
      <li class="breadcrumb-item active" aria-current="page">Cadastro de Tarefa</li>
    </ol>
  </nav>
</div>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="form-group mt-4 text-right">
          ...
          <a href="<?php echo site_url("tarefas"); ?>" class="btn btn-secondary btn-sm ml-2 mb-2">Cancelar</a>
        </div>
      </div>
